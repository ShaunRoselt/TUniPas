...
finalization
  if Assigned(TUniPas.FRouting) then
    FreeAndNil(TUniPas.FRouting);
  if Assigned(TUniPas.FLanguageSupport) then
    FreeAndNil(TUniPas.FLanguageSupport);
  if Assigned(TUniPas.FAppSettings) then
    FreeAndNil(TUniPas.FAppSettings);
